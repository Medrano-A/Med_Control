...
public class DetalleReceta extends Model<DetalleReceta> {
    ...
    public int getIdDetReceta()            { return idDetReceta; }
    public void setIdDetReceta(int id)     { this.idDetReceta = id; fillValues(); }
    public int getIdReceta()               { return idReceta; }
    public void setIdReceta(int id)        { this.idReceta = id;    fillValues(); }
    public String getDosis()               { return dosis; }
    public void setDosis(String dosis)     { this.dosis = dosis;    fillValues(); }
